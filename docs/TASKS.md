...
| 卡号 | 任务 | 分支 | 状态 |
| --- | --- | --- | --- |
| T40 | PM｜日期显示公共规则与任务边界 | integration/v2 | 进行中 |
| T41 | 开发员 A｜详情编辑栏字段与滚动 | feat/editor-v23 | 待分发 |
| T42 | 开发员 B｜事项卡进度与日期 | feat/item-card-v23 | 待分发 |
| T43 | 开发员 C｜显示全部与辅助日期 | feat/filter-reset-v23 | 待分发 |
| T44 | 独立测试员｜V2.3 验收 | qa/v2.3 | 待分发 |
| T45 | PM｜集成与开发版验收 | integration/v2 | 待开始 |
