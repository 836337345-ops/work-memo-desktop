...
| T61 | 开发员 B｜最新进度标题与正文同行 | feat/item-card-v25 | 待分发 |
| T62 | 开发员 C｜日历标题、分类多选与节假日 | feat/work-calendar-v25 | 待分发 |
| T63 | 独立测试员｜V2.5 验收 | qa/v2.5 | 待集成后分发 |
| T64 | PM｜集成并启动隔离调试版 | integration/v2 | 待开始 |
