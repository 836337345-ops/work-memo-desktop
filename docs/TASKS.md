...
| 卡号 | 任务 | 分支 | 状态 |
| --- | --- | --- | --- |
| T50 | PM｜保存 V2.3 快照、清理旧工作树、冻结 V2.4 契约 | integration/v2 | 进行中 |
| T51 | 开发员 B｜事项卡底框与字体层级 | feat/item-card-v24 | 待分发 |
| T52 | 开发员 C｜只读工作日历 | feat/work-calendar | 待分发 |
| T53 | 独立测试员｜V2.4 验收 | qa/v2.4 | 待集成后分发 |
| T54 | PM｜集成与调试版验收 | integration/v2 | 待开始 |
