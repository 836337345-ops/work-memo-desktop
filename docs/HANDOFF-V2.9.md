...
后续状态更新（2026年9月9日）：用户已在另一窗口将 `main` 与 `integration/v2` 同步到基线 `906eb7804926dedbb915b515cac5044afa690892`，后续文档维护继续保持两条分支对齐。本文其余“未合入 main”描述仅记录 V2.9 原始交付时点，不代表当前分支状态。
...
- 原始 V2.9 交付时点不包含 `main` 合并、远程推送、上传或发布；当前分支状态以上述后续更新为准。
