...
export interface ItemInput { title: string; content: string; categoryId: string | null; dueDate: string | null; status: ItemStatus; notes: string; followUps: FollowUp[]; isStarred: boolean }
...
export const emptyItem = (categoryId: string | null = null): ItemInput => ({ title: '', content: '', categoryId, dueDate: null, status: 'doing', notes: '', followUps: [], isStarred: false });
