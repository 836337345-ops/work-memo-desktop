...
export default function App() {
  ...
  const [filters, setFilters] = useState<FilterState>({ status: 'all', date: 'all', categoryId: undefined }); const [isTrash, setIsTrash] = useState(false); const [target, setTarget] = useState<EditorTarget>(null); const [showCalendar, setShowCalendar] = useState(false); const [revealItemId, setRevealItemId] = useState<string | null>(null);
