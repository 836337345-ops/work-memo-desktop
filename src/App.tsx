...
export default function App() {
  ...
  return <main className="app-shell"><Sidebar categories={categories} active={active} onNavigate={(next) => void navigate(next)} onManageCategories={() => setShowCategories(true)} onOpenBackup={() => setShowBackup(true)} />
